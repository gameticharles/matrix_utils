...
class Complex {
  ...
  /// ```
  Complex sin() {
    return Complex(math.sin(real) * maths.cosh(imaginary),
        math.cos(real) * maths.sinh(imaginary));
  }
  ...
  /// ```
  Complex cos() {
    return Complex(math.cos(real) * maths.cosh(imaginary),
        -math.sin(real) * maths.sinh(imaginary));
  }

  Complex sinh() => Complex(maths.sinh(real) * math.cos(imaginary),
      maths.cosh(real) * math.sin(imaginary));

  Complex cosh() => Complex(maths.cosh(real) * math.cos(imaginary),
      maths.sinh(real) * math.sin(imaginary));
